...
namespace library
{
    enum MultiMathFunctionType { Addition = 0, Multiplication, Division, Special };

    class MultiMathFunction: ICloneable
    {
    ...
    class FoundationFunction : MultiMathFunction
    {
    ...
    class ArgumentFunction : MultiMathFunction
    {
        private uint index;
    ...
    class CosMultiFunction : FoundationFunction
    {
    ...
    class SinMultiFunction : FoundationFunction
    {
    ...
    class LnMultiFunction : FoundationFunction
    {
    ...
    class PowerMultiFunction : MultiMathFunction
    {
    ...
    class ConstMultiFunction : MultiMathFunction
    {
